        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <div className="absolute inset-0 z-40 flex items-center justify-center px-6">
            <div className="mx-auto max-w-6xl text-center">
              ...
              >
                Taste that
                <span className="block text-white/90 italic">
                  stays with you
                </span>
              </motion.h2>
              ...
              >
                ...
                authentic flavors of South India. Our chefs use
                tradition-honored recipes and hand-ground spices to create the
                perfect tiffin experience. Freshly prepared, timeless flavors,
                and a warm dining atmosphere.
              </motion.p>
